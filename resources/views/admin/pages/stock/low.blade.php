...
@section('title', 'Azalan Ürünler')

@section('content')
    <h1 class="text-lg font-semibold mb-4">Azalan Ürünler</h1>
            ...
            <tbody>
                @forelse($items as $item)
                    <tr
                        ...
                        <td class="px-3 py-2">
                            <span
                                class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-200">
                                {{ $item->stock_label }}
                            </span>
                        </td>
                ...
                @empty
                    <tr>
                        <td class="px-3 py-6 text-center text-gray-500" colspan="5">Azalan stokta ürün bulunmamaktadır.
                        </td>
                    </tr>
                @endforelse
            </tbody>
