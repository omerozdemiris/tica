...
@section('title', 'Müşteri Log Geçmişi')

@section('content')
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold">Müşteri Log Geçmişi</h1>
        ...
        <div class="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800">
            <form action="{{ route('admin.logs.customer') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="type" value="{{ request('type') }}" placeholder="örn: Sipariş"
                        class="w-full bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-2">
                </div>
                <div>
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-8 h-8 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-600 flex items-center justify-center font-bold">
                                ...
                                {{ str_contains($log->type, 'Sipariş')
                                    ? 'bg-green-100 text-green-700 dark:bg-green-900/30'
                                    : (str_contains($log->type, 'Adres')
...
@push('scripts')
    ...
    <script>
        function showLogDetail(id) {
            ...
            const beforeDataJson = container.querySelector('.before-data').textContent;
            const afterDataJson = container.querySelector('.after-data').textContent;
            ...
            try {
                beforeData = JSON.parse(beforeDataJson) || {};
                afterData = JSON.parse(afterDataJson) || {};
            } catch (e) {
        ...
        function exportToExcel() {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "Customer Logs");
            XLSX.writeFile(wb, "musteri-loglari.xlsx");
        }
    </script>
@endpush
