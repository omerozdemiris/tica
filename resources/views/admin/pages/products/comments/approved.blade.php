...
@section('title', 'Onaylanan Değerlendirmeler')
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold">Onaylanan Değerlendirmeler</h1>
    </div>
    ...
    <div id="bulk-actions" class="hidden mb-4 p-4 bg-gray-50 dark:bg-gray-900 rounded-lg flex items-center gap-4">
        ...
        <div class="flex items-center gap-2">
            <button type="button" onclick="bulkAction('status_2')" class="px-3 py-1.5 text-xs font-semibold bg-red-600 text-white rounded-md hover:bg-red-700">Reddet</button>
    ...
    <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-6 py-10 text-center text-gray-500">Onaylanmış değerlendirme bulunmuyor.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
