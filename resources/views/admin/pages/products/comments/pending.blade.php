...
@section('title', 'Bekleyen Değerlendirmeler')
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold">Bekleyen Değerlendirmeler</h1>
    </div>
    ...
    <div class="bg-white dark:bg-black border border-gray-200 dark:border-gray-800 rounded-lg overflow-hidden">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-800">
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-6 py-10 text-center text-gray-500">Bekleyen değerlendirme bulunmuyor.
                        </td>
                    </tr>
                @endforelse
            </tbody>
