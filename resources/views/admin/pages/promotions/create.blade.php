...
@section('title', 'Yeni Promosyon Oluştur')

@section('content')
    <div class="flex items-center justify-between mb-4">
        <h1 class="text-lg font-semibold">Yeni Promosyon Oluştur</h1>
            ...
            <div class="rounded-lg border border-gray-200 dark:border-gray-800 p-4 bg-white dark:bg-black/20">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="code" required placeholder="örn: INDIRIM20"
                    ...
                    <div>
                        ...
                        <input type="number" name="discount_rate" required min="1" max="100" placeholder="20"
                    ...
                    <div>
                        ...
                        <select name="condition_type" id="condition_type"
                            ...
                            <option value="1">Kota Sınırlı</option>
                            <option value="2">Tarih Aralıklı</option>
                            <option value="3">Minimum Sepet Tutarı</option>
                        </select>
                    </div>

                    <div id="usage_limit_wrap" class="hidden">
                        <label class="text-sm font-medium">Kullanım Kotası (Adet)</label>
                        <input type="number" name="usage_limit" min="1"
                            class="w-full mt-1 px-3 py-2 rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-black">
                    </div>

                    <div id="min_total_wrap" class="hidden">
                        <label class="text-sm font-medium">Minimum Sepet Tutarı (₺)</label>
                        <input type="number" name="min_total" min="0" step="0.01"
                            class="w-full mt-1 px-3 py-2 rounded-md border border-gray-200 dark:border-gray-800 bg-white dark:bg-black">
                    </div>

                    <div id="date_range_wrap" class="hidden space-y-4">
                        <div>
                    ...
                    <div class="flex items-center gap-3 py-2">
                        <input type="checkbox" name="public" value="1" class="toggle" checked>
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="rounded-lg border border-gray-200 dark:border-gray-800 p-4 bg-white dark:bg-black/20">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <label
                        class="flex items-center gap-3 p-3 rounded-md border border-gray-100 dark:border-gray-900 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors">
                        <input type="radio" name="type" value="cart_total"
                            class="text-black dark:text-white focus:ring-0">
                        <div>
                            <p class="text-sm font-medium font-medium">Sepet Tutarı</p>
                            <p class="text-[10px] text-gray-500">Tüm alışverişlerde geçerli.</p>
                        </div>
                    </label>
                </div>
            </div>

            <div id="pool-wrapper" class="h-full flex flex-col">
                <div class="rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black/20 flex flex-col">
                    ...
                    <div class="flex-1 grid grid-cols-2 divide-x divide-gray-200 dark:divide-gray-800 min-h-[500px]">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div id="item-pool"
                                class="flex-1 p-2 overflow-y-auto space-y-1 max-h-[500px] relative pool-scrollbar">
                        ...
                        <!-- Selection -->
                        <div class="flex flex-col bg-white dark:bg-black/10">
                            <div
                                class="p-3 bg-gray-50 dark:bg-gray-900/50 text-[10px] font-bold text-gray-400 uppercase tracking-widest border-b border-gray-200 dark:border-gray-800">
                                Geçerli Alanlar
                            </div>
                            <div id="item-selection"
                                class="flex-1 p-2 overflow-y-auto space-y-1 max-h-[500px] pool-scrollbar">
