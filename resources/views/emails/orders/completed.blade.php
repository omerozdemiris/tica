...
<head>
    ...
    <title>{{ config('app.name') }} - Siparişiniz Yola Çıktı</title>
                ...
                <table role="presentation" width="520" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        ...
                        <td align="center" style="padding:36px 32px;background-color:{{ $colors['primary_light'] }};">
                            ...
                            <h1 style="margin:20px 0 4px;font-size:24px;font-weight:700;color:#0f172a;">Siparişiniz yola

                                çıktı 🚚</h1>

                            <p style="margin:0;font-size:14px;color:#475569;">

                                {{ $appName }} ile verdiğiniz sipariş başarıyla kargoya teslim edildi.
                        ...
                        <td style="padding:32px 36px 12px;">
                            ...
                            <div style="display:flex;flex-wrap:wrap;gap:16px;margin-bottom:24px;">
                                ...
                                <div
                                    ...
                                    <p style="margin:0;font-size:12px;text-transform:uppercase;color:#94a3b8;">Teslim
                                    ...
                                    <p style="margin:6px 0 0;font-size:18px;font-weight:600;color:#111827;">
                                        ...
                                        {{ optional($shipping->delivered_at)->format('d.m.Y') ?? now()->format('d.m.Y') }}
                            ...
                            <div
                                style="margin:0 0 24px;padding:20px;border-radius:18px;background-color:#f8fafc;border:1px solid #e2e8f0;">

                                <h3 style="margin:0 0 12px;font-size:16px;color:#0f172a;">Kargo Detayları</h3>
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                    ...
                                    @if ($shipping)
                                        <tr>
                                            ...
                                            <td style="padding:4px 0;color:#64748b;font-size:14px;">Kargo Firması:</td>

                                            <td style="padding:4px 0;color:#0f172a;font-weight:500;font-size:14px;">

                                                {{ $company?->name ?? 'Belirtilmedi' }}</td>

                                        </tr>

                                        <tr>

                                            <td style="padding:4px 0;color:#64748b;font-size:14px;">Takip No:</td>

                                            <td style="padding:4px 0;color:#0f172a;font-weight:500;font-size:14px;">

                                                {{ $shipping->tracking_no }}</td>
                                ...
                                @if ($shipping && $shipping->tracking_link)
                                    <div style="margin-top:16px;">

                                        <a href="{{ $shipping->tracking_link }}{{ $shipping->tracking_no }}"
                                            target="_blank" rel="noopener"
                                            style="display:inline-block;padding:10px 20px;border-radius:10px;background-color:{{ $colors['primary'] }};color:{{ $colors['text_on_primary'] }};text-decoration:none;font-size:14px;font-weight:600;">
