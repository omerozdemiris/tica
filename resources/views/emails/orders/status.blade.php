...
@php
    ...
    $statusLabels = [
        'new' => ['label' => 'Siparişiniz alındı', 'color' => '#3b82f6', 'bg' => '#dbeafe'],

        'pending' => ['label' => 'Siparişiniz hazırlanıyor', 'color' => '#f97316', 'bg' => '#ffedd5'],

        'completed' => ['label' => 'Siparişiniz kargoya verildi', 'color' => '#16a34a', 'bg' => '#dcfce7'],

        'canceled' => ['label' => 'Siparişiniz iptal edildi', 'color' => '#ef4444', 'bg' => '#fee2e2'],
    ];
                ...
                <table role="presentation" width="520" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        ...
                        <td style="padding:32px 36px 12px;">
                            ...
                            @if ($order->method === 'wire' && isset($wireBanks) && $wireBanks->isNotEmpty())
                            ...
                            @if ($order->shipping && $order->shipping->shippingCompany && $status === 'completed')
                                ...
                                <div
                                    ...
                                    <p style="margin:4px 0;color:#0369a1;">
                                        ...
                                        Kargo Firması: {{ $order->shipping->shippingCompany->name }}

                                    </p>

                                    <p style="margin:4px 0;color:#0369a1;">

                                        Takip No: <strong>{{ $order->shipping->tracking_no }}</strong>
                                    ...
                                    @if ($order->shipping->tracking_link)
                                        <p style="margin:10px 0 0;">
                                            ...
                                            <a href="{{ $order->shipping->tracking_link }}" target="_blank"
