...
@section('content')
    ...
    <section class="py-12">
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
            ...
            <div
                class="bg-white border {{ $theme->color ? 'border-' . $theme->color : 'border-gray-200' }} rounded-3xl shadow-sm p-6">

                <h2 class="text-lg font-semibold text-gray-900">Siparişinizi Bulun</h2>

                <p class="text-sm text-gray-500 mt-1">
                    Sipariş numaranız veya e-posta adresiniz ile siparişinizi bulun, detayları görün veya iade talebi
                    oluşturun.
                </p>
                ...
                <form method="GET" action="{{ route('returns.lookup') }}" class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <label
                            class="text-sm font-medium {{ $theme->color ? 'text-' . $theme->color : 'text-gray-700' }}">Sipariş
                            Numarası</label>
                    ...
                    <div>
                        ...
                        <label
                            class="text-sm font-medium {{ $theme->color ? 'text-' . $theme->color : 'text-gray-700' }}">E-posta</label>
            ...
            @elseif($orders && $orders->isNotEmpty())
